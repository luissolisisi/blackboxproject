        ...
        <div class="main-app">
            <div class="head">
              <div id="div10">
                ...
                <h2>Busqueda en listas: <?= $usuario=$this->session->userdata('empresa'); ?></h2>
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nombre" id="nombre" placeholder="Ingresa Nombre" class="form-control" required>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label>Apellido Paterno <span class="text-danger"> * </span></label>
                                        <input type="text" name="apaterno" id="apaterno" placeholder="Ingresa Apellido Paterno" class="form-control" required>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label>Apellido Materno</label>
                                        <input type="text" name="amaterno" id="amaterno" placeholder="Ingresa Apellido Materno" class="form-control" >
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                  ...
                                  <div class="radio">
                                    <label class="">
                                      <div class="iradio_square-blue hover" aria-checked="false" aria-disabled="false" style="position: relative;">
                                        <input type="radio" name="busqueda" value="search_extend"class="icheck" style="position: absolute; opacity: 0;">
                                      </div> Busqueda extendida
                                      <div class="tooltip3"><i class="far fa-question-circle"></i>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="block-flat">
                                    ...
                                    -->
                                      <input type="file" id="documento" name="archivo" accept="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet," class="form-control" required="" autocomplete="off">
                                      <div class="radio">
                                        <div class="form-group">
                                          <label class="col-sm-3 control-label">Elija su tipo de busqueda: </label>
                                          <div class="col-sm-6">
                                            <div class="radio">
                                              <label class="">
                                                <div class="iradio_square-blue" aria-checked="false" aria-disabled="false" style="position: relative;"><div class="iradio_square-blue"  aria-checked="false" aria-disabled="false" style="position: relative;"><input checked type="radio" value="negras" name="opcion" class="icheck" style="position: absolute; opacity: 0;"><ins class="iCheck-helper" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 0;"></ins></div><ins class="iCheck-helper" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 0;"></ins></div>
                                                Solo listas negras (Nacionales e Internacionales)
                                              </label>
                                            </div>

                                            <div class="radio">
                                              <label class="">
                                                <div class="iradio_square-blue" aria-checked="false" aria-disabled="false" style="position: relative;"><div class="iradio_square-blue" aria-checked="false" aria-disabled="false" style="position: relative;"><input type="radio" value="pep" name="opcion" class="icheck" style="position: absolute; opacity: 0;"><ins class="iCheck-helper" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 0;"></ins></div><ins class="iCheck-helper" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 0;"></ins></div>
                                                Solo listas PEP´s (Nacionales e Internacionales)
                                              </label>
                                            </div>

                                            <div class="radio">
                                              <label>
                                                <div class="iradio_square-blue" aria-checked="false" aria-disabled="false" style="position: relative;"><div class="iradio_square-blue" aria-checked="false" aria-disabled="false" style="position: relative;"><input type="radio" value="69b" name="opcion" class="icheck" style="position: absolute; opacity: 0;"><ins class="iCheck-helper" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 0;"></ins></div><ins class="iCheck-helper" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 0;"></ins></div>
                                                Solo lista 69B
                                              </label>
                                            </div>
                                            ...
                                            <div class="radio">
                                              <label>
                                                <div class="iradio_square-blue" aria-checked="false" aria-disabled="false" style="position: relative;"><div class="iradio_square-blue" aria-checked="false" aria-disabled="false" style="position: relative;"><input type="radio" value="CI" name="opcion" class="icheck" style="position: absolute; opacity: 0;"><ins class="iCheck-helper" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 0;"></ins></div><ins class="iCheck-helper" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 0;"></ins></div>
                                                Solo lista de contribuyente incumplido
                                              </label>
                                            </div>

                                            <div class="radio">
                                              <label>
                                                <div class="iradio_square-blue" aria-checked="false" aria-disabled="false" style="position: relative;"><div class="iradio_square-blue" aria-checked="false" aria-disabled="false" style="position: relative;"><input type="radio" value="todas" name="opcion" class="icheck" style="position: absolute; opacity: 0;"><ins class="iCheck-helper" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 0;"></ins></div><ins class="iCheck-helper" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 0;"></ins></div>
                                                Todas las listas (Al seleccionar esta opción las busquedas tardan entre 6 y 20 minutos más dependiendo de la cantidad de registros en su archivo)
                                              </label>
                                            </div>
                                      ...
                                      <div class="modal-footer" id="uno">
                                          <button type="submit" class="btn btn-primary btn-flat" id="btnBuscar" name="btnBuscar" required="">Buscar</button>
                                  </div>
                        ...
                        <table id="list_table" class="no-border oculto">
                            ...
                            <tfoot>
                              <td colspan="8" align="center">
                                  <a id="btnPromt"><strong>No encontraste a la persona que buscabas, da click aqui para ayuda </strong></a><br>
                                  </td>
                            </tfoot>
                        </table>
        ...
        <div class="row">
            ...
            <div class="col-md-2">
              <div class="form-group" id="gen">
                  <label>Genero</label>
                  <input type="text" id="genero" class="form-control"  disabled>
              </div>
...
$('#btnPromt').click(function(){
    swal({
        html: "<div align='left'><p>1. Verificar la ortografia del nombre</p><p>2. En personas morales solo incluir su nombre sin su sufijo</p><p> 3.Eliminar espacios dobles entre palabras</p><p>4. Eliminar caracters especiales (ej. &,-,$)</p><p>5. Usar la busqueda Extendida si no conoce la ortografia del nombre o su orden correcto</p></div>",
          type: "question",
...
alert("Modal Mostrada");
      ...
      $('#search_fisica').on('submit', function(e) {
            ...
            $("#loader").show();
            $.ajax({
                url: '<?= base_url('busqueda/search_lists') ?>',
                type: 'POST',
                dataType: 'html',
                data: $(this).serialize(),
            })
      ...
      $('#search_moral').on('submit', function(e) {
            ...
            $.ajax({
                url: '<?= base_url('busqueda/search_lists_m') ?>',
                type: 'POST',
                dataType: 'html',
                data: $(this).serialize(),
            })
    ...
    function person_info(id = 0){
        ...
        .done(function(response) {
            ...
            if(!response.situacion_del_contribuyente){
              $('#sc').hide();
            }
            else{
              var par1 = "<tr><td>Situación del contribuyente</td><td>";
              var par2= response.situacion_del_contribuyente;
              var par3 = "</td></tr>";
              var uno = par1.concat(par2);
              var dos = uno.concat(par3);
              prue = prue.concat(dos);
              //$('#datos4').val(prue);
              $('#sc').show();
              $('#situacion_del_contribuyente').val(response.situacion_del_contribuyente);
            }
            if(!response.apaterno){
            $('#person_info_name').html('<h4 class="modal-title" id="myModalLabel"><i class="fas fa-user-shield"></i>Información de la persona: '+response.nombre+'</h4>');
            }else{
            $('#person_info_name').html('<h4 class="modal-title" id="myModalLabel"><i class="fas fa-user-shield"></i>Información de la persona: '+response.apaterno+' '+response.amaterno+' '+response.nombre+'</h4>');
            }
            if(!response.rfc){
              $('#rpi').hide();
            }
            ...
            if(!response.numero_y_fecha_de_oficio_global_de_presuncion){
              $('#nyddogp').hide();
            }
            else{
              var par1 = "<tr><td>Numero y fecha del oficio global de presunción</td><td>";
              var par2= response.numero_y_fecha_de_oficio_global_de_presuncion;
              var par3 = "</td></tr>";
              var uno = par1.concat(par2);
              var dos = uno.concat(par3);
              prue = prue.concat(dos);
              $('#nyddogp').show();
              $('#numero_y_fecha_de_oficio_global_de_presuncion').val(response.numero_y_fecha_de_oficio_global_de_presuncion);
            }

            if(!response.publicacion_dof_presuntos){
              $('#pdp').hide();
            }
            else{
              var par1 = "<tr><td>publicacion DOF presuntos</td><td>";
              var par2= response.publicacion_dof_presuntos;
              var par3 = "</td></tr>";
              var uno = par1.concat(par2);
              var dos = uno.concat(par3);
              prue = prue.concat(dos);
              $('#pdp').show();
              $('#publicacion_dof_presuntos').val(response.publicacion_dof_presuntos);
            }

            if(!response.publicacion_pagina_sat_desvirtuados){
              $('#ppsp1').hide();
            }
            else{
              var par1 = "<tr><td>Publicacion en la pagina deL SAT Desvirtuados</td><td>";
              var par2= response.publicacion_pagina_sat_desvirtuados;
              var par3 = "</td></tr>";
              var uno = par1.concat(par2);
              var dos = uno.concat(par3);
              prue = prue.concat(dos);
              $('#ppsp1').show();
              $('#publicacion_pagina_sat_desvirtuados').val(response.publicacion_pagina_sat_desvirtuados);
            }

            if(!response.publicacion_pagina_sat_presuntos){
              $('#ppsp').hide();
            }
            else{
              var par1 = "<tr><td>Publicacion en pagina de SAT Presuntos</td><td>";
              var par2= response.publicacion_pagina_sat_presuntos;
              var par3 = "</td></tr>";
              var uno = par1.concat(par2);
              var dos = uno.concat(par3);
              prue = prue.concat(dos);
              $('#ppsp').show();
              $('#publicacion_pagina_sat_presuntos').val(response.publicacion_pagina_sat_presuntos);
            }

            if(!response.numero_fecha_oficio_global_contribuyentes_desvirtuaron){
              $('#nfogcd').hide();
            }
            else{
              var par1 = "<tr><td>Numero y fecha oficio global de contribuyente desvirtuados</td><td>";
              var par2= response.numero_fecha_oficio_global_contribuyentes_desvirtuaron;
              var par3 = "</td></tr>";
              var uno = par1.concat(par2);
              var dos = uno.concat(par3);
              prue = prue.concat(dos);
              $('#nfogcd').show();
              $('#numero_fecha_oficio_global_contribuyentes_desvirtuaron').val(response.numero_fecha_oficio_global_contribuyentes_desvirtuaron);
            }

            if(!response.publicacion_dof_desvirtuados){
              $('#pdd').hide();
            }
            else{
              var par1 = "<tr><td>Publicacion DOF desvirtuados</td><td>";
              var par2= response.publicacion_dof_desvirtuados;
              var par3 = "</td></tr>";
              var uno = par1.concat(par2);
              var dos = uno.concat(par3);
              prue = prue.concat(dos);
              $('#pdd').show();
              $('#publicacion_dof_desvirtuados').val(response.publicacion_dof_desvirtuados);
            }

            if(!response.numero_y_fecha_de_oficio_global_de_definitivos){
              $('#nfogd').hide();
            }
            else{
              var par1 = "<tr><td>Numero y fechade oficio global de definitivos</td><td>";
              var par2= response.numero_y_fecha_de_oficio_global_de_definitivos;
              var par3 = "</td></tr>";
              var uno = par1.concat(par2);
              var dos = uno.concat(par3);
              prue = prue.concat(dos);
              $('#nfogd').show();
              $('#numero_y_fecha_de_oficio_global_de_definitivos').val(response.numero_y_fecha_de_oficio_global_de_definitivos);
            }

            if(!response.publicacion_pagina_sat_definitivos){
              $('#ppsd').hide();
            }
            else{
              var par1 = "<tr><td>Publicacion SAT Definitivos</td><td>";
              var par2= response.publicacion_pagina_sat_definitivos;
              var par3 = "</td></tr>";
              var uno = par1.concat(par2);
              var dos = uno.concat(par3);
              prue = prue.concat(dos);
              $('#ppsd').show();
              $('#publicacion_pagina_sat_definitivos').val(response.publicacion_pagina_sat_definitivos);
            }

            if(!response.numero_y_fecha_de_oficio_global_de_sentencia_favorable){
              $('#nfogsf').hide();
            }
            else{
              var par1 = "<tr><td>Numero y fecha de oficio global de sentencia favorable</td><td>";
              var par2= response.numero_y_fecha_de_oficio_global_de_sentencia_favorable;
              var par3 = "</td></tr>";
              var uno = par1.concat(par2);
              var dos = uno.concat(par3);
              prue = prue.concat(dos);
              $('#nfogsf').show();
              $('#numero_y_fecha_de_oficio_global_de_sentencia_favorable').val(response.numero_y_fecha_de_oficio_global_de_sentencia_favorable);
            }

            if(!response.publicacion_pagina_sat_sentencia_favorable){
              $('#ppssf').hide();
            }
            else{
              var par1 = "<tr><td>Publicacion pagina del SAT sentencia favorable</td><td>";
              var par2= response.publicacion_pagina_sat_sentencia_favorable;
              var par3 = "</td></tr>";
              var uno = par1.concat(par2);
              var dos = uno.concat(par3);
              prue = prue.concat(dos);
              $('#ppssf').show();
              $('#publicacion_pagina_sat_sentencia_favorable').val(response.publicacion_pagina_sat_sentencia_favorable);
            }

            if(!response.publicacion_dof_sentencia_favorable){
              $('#pdsf').hide();
            }
            else{
              var par1 = "<tr><td>Publicacion DOF sentencia favorable</td><td>";
              var par2= response.publicacion_dof_sentencia_favorable;
              var par3 = "</td></tr>";
              var uno = par1.concat(par2);
              var dos = uno.concat(par3);
              prue = prue.concat(dos);
              $('#pdsf').show();
              $('#publicacion_dof_sentencia_favorable').val(response.publicacion_dof_sentencia_favorable);
            }

            if(!response.publicacion_dof_definitivos){
              $('#pdfd').hide();
            }
            else{
              var par1 = "<tr><td>Publicacion DOF definitivos</td><td>";
              var par2= response.publicacion_dof_definitivos;
              var par3 = "</td></tr>";
              var uno = par1.concat(par2);
              var dos = uno.concat(par3);
              prue = prue.concat(dos);
              $('#pdfd').show();
              $('#publicacion_dof_definitivos').val(response.publicacion_dof_definitivos);
            }
                        ...
                        if(!response.genero){
                          ...
                          var par1 = "<tr><td>Genero</td><td>";
                          var par2= response.genero;
                          var par3 = "</td></tr>";
                          var uno = par1.concat(par2);
                          var dos = uno.concat(par3);
                          prue = prue.concat(dos);
                        ...
                        if(!response.email){
                          ...
                          var par1 = "<tr><td>Email</td><td>";
                          var par2= response.email;
                          var par3 = "</td></tr>";
                          var uno = par1.concat(par2);
                          var dos = uno.concat(par3);
                          prue = prue.concat(dos);
            ...
            if(!response.numero_oficio_personas_bloqueadas){
              $('#nofpb').hide();
            }
            else{
              var par1 = "<tr><td>Numero de oficio de personas bloqueadas</td><td>";
              var par2= response.numero_oficio_personas_bloqueadas;
              var par3 = "</td></tr>";
              var uno = par1.concat(par2);
              var dos = uno.concat(par3);
              prue = prue.concat(dos);
              $('#nofpb').show();
              $('#numero_oficio_personas_bloqueadas').val(response.numero_oficio_personas_bloqueadas);
            }
