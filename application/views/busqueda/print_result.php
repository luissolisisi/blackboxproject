...
<div id="infoBusq">La busqueda fue realizada por:
 <?php
 $CI =& get_instance();
 ...
 <?php
 $time = time();
 echo date("d-m-Y (H:i:s)", $time).' '.$nombre.' ('.$estatus.') ';
 ?>
</div>
...
<div id="infoFuentes">
  ...
  <ul>
    ...
    <li>Instituto Nacional de Tranparencia, Acceso a la información y Protección de Datos Personales (INAI)</li>
